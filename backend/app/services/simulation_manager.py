...
class SimulationManager:
    ...
    4. Prepare all files needed by the preset scripts
    """
    ...
    def prepare_simulation(
        ...
        2. Generate an OASIS Agent Profile for each entity (optional LLM enhancement, with parallel support)
        3. Use LLM to intelligently generate simulation configuration parameters (timing, activity levels, posting frequency, etc.)
