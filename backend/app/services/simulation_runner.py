...
class SimulationRunner:
    ...
    # Legacy class-level dir; use _run_state_dir(user_id) instead
    _LEGACY_RUN_STATE_DIR = os.path.join(
        os.path.dirname(__file__),
        '../../uploads/simulations'
    )

    @classmethod
    def _run_state_dir(cls, user_id: str) -> str:
        from ..utils.paths import user_simulations_dir
        return user_simulations_dir(user_id)
    ...
    def _sim_base(cls, simulation_id: str, user_id: str = None) -> str:
        ...
        return cls._LEGACY_RUN_STATE_DIR
    ...
    def start_simulation(
        ...
        sim_dir = os.path.join(cls._sim_base(simulation_id), simulation_id)
                        ...
                        try:
                            ...
                            if "event_type" in action_data:
                                ...
                                if event_type == "simulation_end":
                                    ...
                                    # If only one platform was running, check only that platform
    ...
    def _check_all_platforms_completed(cls, state: SimulationRunState) -> bool:
        ...
        Determines which platforms are enabled by checking whether the corresponding actions.jsonl file exists
    ...
    def get_all_actions(
        ...
        # Read Twitter action file (auto-sets platform to twitter based on file path)
        twitter_actions_log = os.path.join(sim_dir, "twitter", "actions.jsonl")
        ...
        # Read Reddit action file (auto-sets platform to reddit based on file path)
        reddit_actions_log = os.path.join(sim_dir, "reddit", "actions.jsonl")
    ...
    def register_cleanup(cls):
        ...
        # If not in debug mode, this env var won't exist, and we still need to register
    ...
    def interview_agent(
        ...
        Args:
            ...
            platform: Target platform (optional)
                ...
                - None: In dual-platform mode, interview both platforms and return combined results
    ...
    def close_simulation_env(
        ...
        try:
            ...
            # Timeout may be because the environment is in the process of shutting down
            return {
                "success": True,
