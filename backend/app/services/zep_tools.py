...
Wraps graph search, node retrieval, and edge query tools for use by the Report Agent.

Core search tools (optimized):
1. InsightForge (Deep Insight Search) - The most powerful hybrid search; auto-generates sub-queries and searches across multiple dimensions
2. PanoramaSearch (Broad Search) - Retrieves the full picture, including expired content
...
class InsightForgeResult:
    ...
    Contains search results from multiple sub-queries, along with consolidated analysis
    """
    query: str
...
class PanoramaResult:
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            f"## Broad Search Results (Predictive Panoramic View)",
            f"Query: {self.query}",
            f"\n### Statistics",
        ...
        # Currently active facts (full output, untruncated)
        ...
        # Key entities (full output, untruncated)
        if self.all_nodes:
            text_parts.append(f"\n### [Entities Involved]")
...
class AgentInterview:
    ...
    def to_text(self) -> str:
        ...
        # Display the full agent_bio, untruncated
...
class InterviewResult:
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            ...
            "\n### Rationale for Selecting Interviewees",
...
class ZepToolsService:
    ...
    4. interview_agents - In-depth interviews (interview simulated Agents for multi-perspective insights)
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Retrieve all edges in the graph (with pagination, including temporal info)
    ...
    def get_entity_summary(
        ...
        """
        Get relationship summary for a given entity
    ...
    def insight_forge(
        ...
        The most powerful hybrid search function; automatically decomposes queries and searches across multiple dimensions:
        1. Uses LLM to break the query into multiple sub-queries
    ...
    def _generate_sub_queries(
        ...
        """
        system_prompt = """You are an expert question analyst. Your task is to break down a complex question into multiple sub-questions that can be independently investigated within a simulated world.
...
Return the sub-questions in JSON format."""
    ...
    def panorama_search(
        ...
        Retrieves the full picture, including all related content and historical/expired information:
        ...
        Ideal for understanding the full scope of events and tracking their evolution.
    ...
    def quick_search(
        ...
        3. Suitable for simple, straightforward search needs
    ...
    def interview_agents(
        ...
        Calls the real OASIS interview API to interview currently running simulated Agents:
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "4. Answer each question in order, prefixed with 'Question X:' (where X is the question number)\n"
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Strategy 2 (supplementary): Properly paired Chinese quotation marks with long text inside
                if not key_quotes:
...
6. Ask directly without background preambles or prefixes
