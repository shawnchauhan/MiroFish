...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        ...
        # Return "agent name: activity description" format directly, without simulation prefixes
...
class ZepGraphMemoryUpdater:
    ...
    Groups by platform, sending batch updates to Zep after accumulating BATCH_SIZE activities.
    ...
    def _flush_remaining(self):
        ...
        # Then send remaining activities from each platform's buffer (even if below BATCH_SIZE)
        with self._buffer_lock:
