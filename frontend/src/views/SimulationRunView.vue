...
// Get maxRounds from query params at init time so child component receives the value immediately
...
const loadGraph = async (graphId) => {
  // During simulation, auto-refresh should not show full-screen loading to avoid flickering
