  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          <div class="tag-row">
            <span class="orange-tag">A Universal Swarm Intelligence Engine</span>
          ...
          <div class="hero-desc">
            ...
            <p class=”slogan-text”>
              Let the future rehearse among Agents, let decisions emerge victorious<span class=”blinking-cursor”>_</span>
            </p>
          </div>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parsed prediction tasks & dynamic temporal memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction goal in natural language (e.g., What public sentiment would emerge if a university reversed a controversial disciplinary decision?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
